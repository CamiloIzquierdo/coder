export const TestimoniosMockup = [
    {
        id: 0,
        nombre: "Silvana",
    ...
    },
    {
        id: 1,
        nombre: "Hernán",
        cargo: "Lic. en administración de empresas.",
        imagen: "hernan.svg",
        texto: "Excelente proceso para el desarrollo personal y una gran ayuda para aclarar el camino hacia el logro de objetivos. Manuel aplica de forma permanente retroalimentación, lo cual te permite obtener muchos puntos de vista y conectarte con tu creatividad. Te hace pensar todo para pasar a un siguiente nivel.",
    },
    {
        id: 2,
        nombre: "Alejandra",
        cargo: "Maestra de nivel inicial y emprendedora.",
        imagen: "alejandra.svg",
        texto: "He podido potenciar mi desempeño de una manera creativa, reflexionando sobre mis propias experiencias e impulsando a nuevas maneras de ver las situaciones cotidianas.",
    },
    {
        id: 3,
        nombre: "Ezequiel",
